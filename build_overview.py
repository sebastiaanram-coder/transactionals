...
WELCOME_DETAIL = {
 "Vb23CK": dict(
   ...
   variant="Barely affected in practice: this fires within minutes of sign-up, so almost nobody will have ordered yet. If they have, the promo bar, the code chip and the \u201cyour 10% comes off at checkout\u201d line come out, and the CTA changes from \u201cStart your first order\u201d to a plain browse.",
   elements=[
     ...
     ("Product grid: image, title, quantity, price.", "Removes the navigation step at peak intent and puts real prices in front of someone who has never seen one. Each tile click is also a category signal, which is the only thing that can make Browse Abandonment relevant later."),
