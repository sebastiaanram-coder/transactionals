...
EMAIL_DETAIL = {
 ...
 "SJV6Kx": dict(
   ...
   elements=[
     ("Header photograph of the team checking files.", "Colleagues at screens going through customer work. It sits between the black masthead and the white hero, so neither edge needs a fade baked into it \u2014 the reason every other hero in the programme does."),
