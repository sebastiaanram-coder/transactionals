...
ISSUES = [
 ...
 "All five category nudges are built, and all five have a landing page. Three images are still outstanding, and each falls back to a Contentful packshot on white that reads as the odd one out beside the art-directed shots around it: Beach Flags in Signage & Outdoor, and Pens and Notebooks in Corporate Gifts. A greeting-card shot would additionally buy Cards & Invitations its tile back in Commercial Print. Clothing & Textiles and Corporate Gifts also carry a band of three in-setting brand shots taken from the carousel on /our-brands.",
