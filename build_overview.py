...
ISSUES = [
 ...
 "Two of the five category nudges are built. The other three have no photography at all: Labels & Packaging, Clothing & Textiles and Corporate Gifts need twelve shots in the same style, thirteen with a greeting card, which also buys Cards & Invitations its tile back in Commercial Print. Signage & Outdoor is complete except for Beach Flags, whose tile falls back to its packshot on white and sits oddly beside three art-directed shots. Those three also need a landing page each; Commercial Print and Signage & Outdoor now have theirs.",
