 ...
 dict(slug="post-purchase", name="Post-Purchase", stage="Onboard", flow_id="TZYvDF",
   ...
   emails=[
    dict(step=1, when="Day 18", subject="Would you tell other businesses how it went?",
      ...
      section="Rebuilt flow \u2014 proposed",
      section_sub="Three of six designed. The review request at day 18, the reminder at day 25 and the category nudge at day 32; the print expert and the two discount emails are specified in proposals/post-purchase-proposal.md but not yet designed.",
