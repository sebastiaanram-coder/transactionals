...
EMAIL_DETAIL = {
 "POST01": dict(
   ...
   elements=[
     ("A photograph, then the ask.", "The first version was a wordmark, a headline and a 132px star strip, and it was dull. The header now carries a photograph that runs to the top of the card and fades into the ink, the same shape as the category nudge, with the fade baked into the JPEG because Outlook ignores CSS gradients."),
