...
ISSUES = [
 ...
 "All five category nudges are built, all five have a landing page, and every one of their twenty-two images is now an in-setting shot rather than a packshot on white. Clothing & Textiles and Corporate Gifts also carry a band of three in-setting brand shots taken from the carousel on /our-brands. One photograph would still earn its place: a greeting card, which buys Cards & Invitations its tile back in Commercial Print in place of the roller banner standing in there now.",
